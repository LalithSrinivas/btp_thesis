...
\begin{table}[H]
	...
	\begin{tabular}{|r|r|}
		\hline
		\multicolumn{1}{|l|}{\textbf{Type}} & \multicolumn{1}{l|}{\textbf{Metric}} \\ \hline
		MRR                                    & 0.209815                                      \\ \hline
		Hits@1                                    & 0.154256                                   \\ \hline
		Hits@3                                    & 0.224470                                    \\ \hline
		Hits@5                                    & 0.260750                                     \\ \hline
		Hits@10                                    & 0.314302                                    \\ \hline
	\end{tabular}
...
\begin{table}[H]
	...
	\begin{tabular}{|r|r|r|}
		\hline
		\multicolumn{1}{|l|}{\textbf{Type}} & \multicolumn{1}{l|}{\textbf{k=10}} & \multicolumn{1}{l|}{\textbf{k=100}} \\ \hline
		MRR                                    & 0.563997      	&0                                \\ \hline
		Hits@1                                    & 0.460471		&0                                   \\ \hline
		Hits@3                                    & 0.565230		&0                                    \\ \hline
		Hits@5                                    & 0.641405		&0                                     \\ \hline
		Hits@10                                    & 0.884442	&0                                    \\ \hline
	\end{tabular}
...
However, for evaluating the test dataset, the new implementation still takes around 5 days to complete. While it is much better than the time taken for evaluation of the old model, it is still not desirably fast enough. So we decided to use our trained TransE parameters to extract the top k candidate entities to rank over. Since the 'score' function is much faster in the new model, evaluating TransE is much faster and the eva;uation only takes about \~15 minutes to complete.
...
\begin{table}[H]
	...
	\begin{tabular}{|r|r|r|}
		...
		Hits@10                                    & 0.884442	&0                                    \\ \hline
	\end{tabular}
	\caption{Metrics of updated CTP using TransE parameters over FreeBase. }
	\label{tab:transE_MRR}
\end{table}
